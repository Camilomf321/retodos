...
namespace capa_datos
{
    public class Clase_Datos
    {
        ...
        public DataTable D_ver_libros() 
        {
            SqlCommand cmd = new SqlCommand("sp_ver_libros", cn); 
        ...
        public DataTable D_buscar_libro(Clase_Logica obje) 
        {
        ...
        public String D_modificar_libro(Clase_Logica obje) 
        {
            String accion = "";
